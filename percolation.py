...
def optimize_spreading_probability_from_data(simulation_data_save_folder, simulation_data_save_name_base, pooled_data_save_path, equal_spreading_params=False, max_n_iterations=None, pool_physiological_only=False):
    ...
    if equal_spreading_params:
        ...
        realized_n_probability_iterations,_, physiological_frac_exposed, stochastic_frac_exposed, physiological_effective_resistance, stochastic_effective_resistance, delayed_embolism = read_and_combine_spreading_probability_optimization_data(simulation_data_save_folder, simulation_data_save_name_base, pooled_data_save_path, max_n_iterations=max_n_iterations)
