...
if __name__=='__main__':
    ...
    physiological_colors = fsylvatica_params.vc_colors
    vc_linestyles = [fsylvatica_params.vc_linestyle for i in range(len(physiological_colors))]
    ...
    csv_save_path = fsylvatica_params.P50_csv_save_path

    visualization.plot_optimized_vulnerability_curve(data_save_folders, physiological_colors, params.stochastic_vc_color, 
            params.physiological_vc_alpha, params.stochastic_vc_alpha, vc_linestyles, optimized_vc_labels,
                                                     ...
                                                     physiological_only=True, csv_save_path=csv_save_path)
