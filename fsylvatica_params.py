...
segment_properties = {'M42':{'Dc':2.980032051282051e-05, 'Dc_std':1.0585625075100896e-05, 'fc':0.0183653508974359, 'fpf':0.5354785240000001},
                      'M23':{'Dc':2.3741391359593392e-05, 'Dc_std':7.422736160256487e-06, 'fc':0.05784052033163914, 'fpf':0.5415683649999999},
                      'M39':{'Dc':2.827737676056338e-05, 'Dc_std':8.986635577283445e-06, 'fc':0.03685643433450705, 'fpf':0.629453652},
                      'M41':{'Dc':2.8415688073394494e-05, 'Dc_std':1.0588179709436388e-05, 'fc':0.01847648837876802, 'fpf':0.42283072},
                      'M32':{'Dc':2.646912296564195e-05, 'Dc_std':8.545644928363257e-06, 'fc':0.031585857980108496, 'fpf':0.439700342},
                      'M31':{'Dc':2.730665898617512e-05, 'Dc_std':3.3230200000000006e-05, 'fc':0.03448462905069125, 'fpf':0.6480547249999999},
                      'M100':{'Dc':3.3230200000000006e-05, 'Dc_std':1.2722401534975338e-05, 'fc':0.03512025761, 'fpf':0.60086713},
                      'M101':{'Dc':3.358575714285714e-05, 'Dc_std':1.2997184612650007e-05, 'fc':0.03637043749, 'fpf':0.647937014},
                      'M24':{'Dc':2.566723716381418e-05, 'Dc_std':8.67623321298386e-06, 'fc':0.03596413490709047, 'fpf':0.508086274},
                      'M102':{'Dc':3.131887323943661e-05, 'Dc_std':1.3539058838167754e-05, 'fc':0.03554364860362172, 'fpf':0.5789179089999998}}
 
segment_names = ['M102', 'M101', 'M100', 'M42', 'M41', 'M39','M31', 'M32', 'M24', 'M23']
...
Dc = np.array([segment_properties[segment_name]['Dc'] for segment_name in segment_names])
Dc_std = np.array([segment_properties[segment_name]['Dc_std'] for segment_name in segment_names])
Dc_cv = Dc_std / Dc
...
fc = [segment_properties[segment_name]['fc'] for segment_name in segment_names]
fpf = [segment_properties[segment_name]['fpf'] for segment_name in segment_names]
...
vc_linestyle = '-'
vc_colors = sns.color_palette('husl', len(segment_names))
pressures_to_be_visualized = np.concatenate((np.zeros(1), np.arange(0.5, 3.0, step=0.05)))*1E6

P50_csv_save_path = '/m/cs/scratch/networks/aokorhon/tree-percolation/output/fsylvatica_P50_data.csv'
