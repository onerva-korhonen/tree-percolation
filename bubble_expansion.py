"""
Functions for estimating the probability of spontaneous embolism due to bubble expansion. For details of the formalism, see Ingram, Reischl, Vesala & Vehkamaki 2024,
